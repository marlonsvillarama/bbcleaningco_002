...
<div class="grid gap-2">
    ...
    <div class="grid gap-1 text-sm">
        <div class="flex items-center justify-between border-b-1 border-gray-100 py-1">
            <span class="py-1 text-clip text-top font-extralight">Deep cleaning with DTI representative</span>
            <div class="flex items-center gap-3">
                <span class="text-right py-1 min-w-[70px] align-top font-bold">500.00</span>
        ...
        <div class="flex items-center justify-between border-b-1 border-gray-100 py-1">
            <span class="py-1 text-clip text-top font-extralight">Carpet shampoo</span>
            <div class="flex items-center gap-3">
                <span class="text-right py-1 min-w-[70px] align-top font-bold">300.00</span>
                <Button variant="icon" size="sm" class="border-transparent border-1 hover:border-gray-200 hover:bg-gray-50 hover:shadow-sm"><CircleX /></Button>
            </div>
        </div>
        <div class="flex items-center justify-between border-b-1 border-gray-100 py-1">
            <span class="py-1 text-clip text-top font-extralight">Window cleaning</span>
            <div class="flex items-center gap-3">
                <span class="text-right py-1 min-w-[70px] align-top font-bold">200.00</span>
                <Button variant="icon" size="sm" class="border-transparent border-1 hover:border-gray-200 hover:bg-gray-50 hover:shadow-sm"><CircleX /></Button>
            </div>
        </div>
    </div>
