...
<div class="grid gap-1 items-center">
	...
	<input
		...
		{disabled}
		class={cn(
		    "border-foreground/30 bg-background selection:bg-primary dark:bg-input/30 selection:text-primary-foreground ring-offset-background placeholder:text-muted-foreground/40 flex h-8 w-[160px] min-w-0 rounded-xs border px-3 py-1 text-base outline-none transition-[color,box-shadow] disabled:cursor-not-allowed disabled:opacity-50 text-sm",
